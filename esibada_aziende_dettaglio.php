							...
							?>
								<nav class="breadcrumb-container" aria-label="breadcrumb">
									<ol class="breadcrumb">             
										...
										<li class="breadcrumb-item"><a href="esibada_aziende.php" title="Vai all'elenco delle aziende" class="">Aziende</a><span class="separator">/</span></li>
			...
			<section id="sezioni-eventi">
				<main id="main-content" class="container px-4 my-4">
					...
					<form id="frm_fornitore" method="post" enctype="multipart/form-data" action="esibada_aziende_dettaglio.php" class="form-horizontal">
						...
						<center>
							<button name="_indietro" id="_indietro" type="button" class="btn btn-primary btn-md" onclick="indietro()" style="<?php if($pflag_fornitore=="true") echo "display:none;"; ?>">Indietro</button>
						...
						<input type="hidden" id="_f" name="_f" value="<?php echo $pflag_fornitore; ?>">
...
function indietro()
{
	window.location.href=("./esibada_aziende.php");
}
</script>
