					...
					<div class="row">
						<div class="col-sm">
							...
							<h5>Benvenuto nel Portale dei lavoratori socio-sanitario del Comune di Ozieri.<br>
								Qui potrai registrarti per poterti candidare nel tuo comune come lavoratore socio-sanitario <br>
							</h5>
						</div>
						<div class="col-md-8 offset-md-2 col-lg-4 offset-lg-4">
							<h1 class="text-center title">Area riservata</h1><br>
							<form style="max-width: 400px;margin: 0 auto;" class="validate-form" method="post"
								action="/user/login" name="loginform">
								<input type="hidden" name="hidden" value="" />
								<div class="form-group">
									<div class="controls">
										<label for="user" class="form-label active">Login</label>
								...
								<div class="text-center mb-5">
									...
									<a href="sibada_registrazione.php">Non hai le credenziali, registrati</a><br>
...
<script>
	...
	function doLOGIN() {
		...
		setTimeout(function () {
			...
			var params = "_action=sibadalogin&_u=" + flduser + "&_p=" + fldpwd;
	...
	function doRegistrazione() {
		window.location = ('sibada_registrazione.php');
	}

	function openRichiestaPassword() {
		window.location = ('sibada_richiestapassword.php');
	}
</script>
